...
bool encryptData(ChaCha *cipher)
{
    ...
    byte iv[8] = {getrnd(),getrnd(),getrnd(),getrnd(),getrnd(),getrnd(),getrnd(),getrnd()};

    byte counter[8] = {getrnd(),getrnd(),getrnd(),getrnd(),getrnd(),getrnd(),getrnd(),getrnd()};
    ...
    memcpy(enc_dataPacket + 123, &iv, 8);
    memcpy(enc_dataPacket + 131, &counter, 8);
}
